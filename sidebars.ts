          ...
          items: [
            'link/services/core/index',
            {
              ...
              items: [
                ...
                'link/services/core/api-reference/asset-categories',
                'link/services/core/api-reference/limits',
              ],
            },
        ...
        },
        {
          ...
          items: [
            'link/services/account_manager/index',
            {
              ...
              items: [
                'link/services/account_manager/api-reference/participants',
                'link/services/account_manager/api-reference/customers',
                'link/services/account_manager/api-reference/accounts',
                'link/services/account_manager/api-reference/wallets',
              ],
            },
          ...
          items: [
            'link/services/quote/index',
            {
              ...
              items: [
                ...
                'link/services/quote/api-reference/quote-settings',
              ],
            },
        ...
        },
        {
          ...
          items: [
            'link/services/router/index',
            {
              ...
              items: [
                'link/services/router/api-reference/account',
                'link/services/router/api-reference/customers',
                'link/services/router/api-reference/messages',
              ],
            },
        ...
        },
        {
          ...
          items: [
            'link/services/verify/index',
            {
              ...
              items: ['link/services/verify/api-reference/sanctions'],
            },
